# Monomech (Moncolar Biomechanics)

`monomech` is a modular monocular biomechanics library for turning video into inspectable kinematics, OpenSim-ready artifacts, and analysis-friendly tables.
